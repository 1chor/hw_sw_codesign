...
void test()
{
    ...
    while (1)
    {
        // ich glaube hier wird der audio buffer raus geschrieben.
        // wenn ich ein lied verarbeiten möchte und dann auf der sd karte
        // speichern, dann sollte mir das derweil egal sein koennen.
        ...
        //~ {
            ...
            // hier hol ich mir scheinbar die samples heraus.
            // input ist die audio datei.
