...
add_fileset_file fir.vhd VHDL PATH ../vhdl/fir/src/fir.vhd TOP_LEVEL_FILE
...
# parameters
# 
add_parameter NUM_COEFFICIENTS POSITIVE 512
set_parameter_property NUM_COEFFICIENTS DEFAULT_VALUE 512
set_parameter_property NUM_COEFFICIENTS DISPLAY_NAME NUM_COEFFICIENTS
set_parameter_property NUM_COEFFICIENTS TYPE POSITIVE
set_parameter_property NUM_COEFFICIENTS UNITS None
set_parameter_property NUM_COEFFICIENTS ALLOWED_RANGES 1:2147483647
set_parameter_property NUM_COEFFICIENTS HDL_PARAMETER true
...
add_parameter ADDR_WIDTH POSITIVE 9
set_parameter_property ADDR_WIDTH DEFAULT_VALUE 9
...
add_interface_port avalon_streaming_sink stin_data data Input data_width
...
add_interface_port avalon_slave_0 mm_address address Input addr_width
add_interface_port avalon_slave_0 mm_write write Input 1
add_interface_port avalon_slave_0 mm_read read Input 1
add_interface_port avalon_slave_0 mm_writedata writedata Input data_width
add_interface_port avalon_slave_0 mm_readdata readdata Output data_width
...
add_interface_port avalon_streaming_source stout_data data Output data_width
