...
add_fileset_file fft_wrapper_header.vhd VHDL PATH ../vhdl/fft/fft_wrapper/fft_wrapper_header.vhd TOP_LEVEL_FILE
...
add_interface_port external_connection inverse export Input 1
