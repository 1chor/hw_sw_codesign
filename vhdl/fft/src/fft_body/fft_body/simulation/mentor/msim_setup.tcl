...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/fft_body_fft_ii_0_3n8192cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_body_fft_ii_0_2n8192sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_body_fft_ii_0_3n8192sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_body_fft_ii_0_1n8192cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_body_fft_ii_0_2n8192cos.hex ./
  file copy -force $QSYS_SIMDIR/submodules/fft_body_fft_ii_0_1n8192sin.hex ./
}
...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fft_body_fft_ii_0.sv"                               -work fft_ii_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QSYS_SIMDIR/fft_body.vhd"                                                                
}
